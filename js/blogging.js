    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(blogResponse, function (index, value) {
                ...
                <img src='${currentImage}' id='bloggingImage'><br><h4>${blogTitle}</h4><br><span>${subCurrentMessage}</span><br><a href="http://localhost:3000/posts/${this.id}" id=${id} class='seeMore'>See More -></a>
                </div>`;
